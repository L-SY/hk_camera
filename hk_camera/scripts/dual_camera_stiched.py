...
bridge = CvBridge()
H = np.load("dual_camera_calibration/H_right_to_left.npy")  # Homography from right to left
...
def publisher():
    ...
    if use_flat_field:
        ...
        flat_left = np.load("dual_camera_flat_field/flat_left.npy")
        flat_right = np.load("dual_camera_flat_field/flat_right.npy")
    else:
